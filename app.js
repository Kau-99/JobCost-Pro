...
function initAuth() {
  ...
  overlay.innerHTML = `
    <div class="authCard">
      ...
      <div class="authSocialRow">
        <button id="authGoogleBtn" class="authSocialBtn authGoogleBtn" type="button">
        ...
        <button id="authAppleBtn" class="authSocialBtn authAppleBtn" type="button">
          <svg width="17" height="17" viewBox="0 0 814 1000" xmlns="http://www.w3.org/2000/svg">
            <path fill="white" d="M788.1 340.9c-5.8 4.5-108.2 62.2-108.2 190.5 0 148.4 130.3 200.9 134.2 202.2-.6 3.2-20.7 71.9-68.7 141.9-42.8 61.6-87.5 123.1-155.5 123.1s-85.5-39.5-164-39.5c-76 0-103.7 40.8-165.9 40.8s-105-36.8-162.8-121.3C66.1 753.3 0 621.2 0 497.5 0 257.8 168.8 130.2 331.7 130.2c78.7 0 144.3 51.6 193.6 51.6 46.8 0 120-54.9 209.6-54.9 33.5 0 138.5 3.8 206.7 107.1zm-105.5-132c26.5-31.2 48.5-75.5 48.5-119.8 0-6.1-.6-12.2-1.9-17.2-45.9 1.9-100.9 30.5-134.5 67.2-25.2 28.5-49.2 72.8-49.2 117.8 0 6.7 1.3 13.5 1.9 16.4 2.5.7 6.4 1.3 10.3 1.3 41.2 0 92.2-28.5 124.9-65.7z"/>
          </svg>
          Sign in with Apple
        </button>
      </div>
